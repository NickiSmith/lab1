/* Nicki Smith Leaflet Lab Map (Lab 1 GEOG 575) September 2019*/
...
function createMap() {  
    ...
    var terrain = L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/terrain/{z}/{x}/{y}{r}.{ext}', {
        attribution: 'Map tiles by <a href="http://stamen.com">Stamen Design</a>, <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> &mdash; Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &mdash; Observation Data provided by <a href="https://ebird.org/home">eBird</a>  &mdash; origami bird by Symbolon from the Noun Project',
        subdomains: 'abcd',
        minZoom: 0,
        maxZoom: 18,
        ext: 'png'
    ...
    //create Stamen Toner base tilelayer
    ...
    //add city markers to layer group
    ...
    //create object with basemaps for layer control
    var basemaps = {
        "Terrain": terrain,
        "Toner": toner
    }
    
    //create object with cities array for layer control
    var overlayMaps = {
        "Cities": cities
    };
    
    //add basemap and overlay objects to layer control    
